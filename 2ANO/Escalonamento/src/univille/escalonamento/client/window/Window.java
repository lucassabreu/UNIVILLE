...
public abstract class Window extends JFrame {
     ...
     */
    public Window() {
        setTitle("JARVIS - Algoritmos de Escalonamento");
        initialize();
    }
    ...
    private void initialize() {
        ...
        groupLayout.setHorizontalGroup(groupLayout
                        ...
                        .addGroup(groupLayout
                                        ...
                                        .addContainerGap()
                                        .addComponent(pnContainer, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addContainerGap())
                        .addComponent(toolBar, GroupLayout.DEFAULT_SIZE, 650, Short.MAX_VALUE));
        groupLayout.setVerticalGroup(groupLayout
                        ...
                        .addGroup(groupLayout
                                        ...
                                        .addComponent(pnContainer, GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
                                        .addContainerGap()));
        ...
        gl_pnParams.setHorizontalGroup(gl_pnParams
                        .createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_pnParams
                                        .createSequentialGroup()
                                        .addContainerGap()
                                        .addGroup(gl_pnParams
                                                        .createParallelGroup(Alignment.LEADING)
                                        ...
                                        .addContainerGap()));
        gl_pnParams.setVerticalGroup(gl_pnParams
                        .createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_pnParams
                                        .createSequentialGroup()
                                        .addContainerGap()
        ...
        gl_pnParams.linkSize(SwingConstants.HORIZONTAL, new Component[] {
                btCarregar, btExecutar });
